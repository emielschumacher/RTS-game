...
{
    public FormationUnitBehaviour formationUnitBehaviour;
    ...
    private void Update()
    {
        // NavigationPathPending navigationPathPending = new NavigationPathPending();

        // Transform formationHolderPointTransform = formationUnitBehaviour.formationHolderPoint;
        // float distance = Vector3.Distance(formationUnitBehaviour.transform.position, formationHolderPointTransform.position);
        
        // SetMovingState(
        //     navigationPathPending.IsPathPending(
        //         formationUnitBehaviour.GetComponent<NavMeshAgent>()
        //     )
        // );
