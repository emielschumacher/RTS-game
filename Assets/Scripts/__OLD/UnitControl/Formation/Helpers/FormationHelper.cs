...
{
    public static List<Vector3> SquareFormation(int unitAmount, Vector3 targetPosition)
    {
        ...
        for (int i = 0; i < unitAmount; i++)
        {
            ...
            if(unitAmount > 1) {
                ...
                formationPosition = new Vector3(targetPosition.x, 0, targetPosition.z + 0.5f);
            }
